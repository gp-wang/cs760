...
public class Instance {
	...
	public Instance(Instance ins) {
		...
		numericAttrMap = new HashMap<Integer, Double>(ins.numericAttrMap); 
		nominalAttrMap = new HashMap<Integer, String>(ins.nominalAttrMap);
...
//	}	
	...
	public String getFeatureValue(int feature, DataSet data) {
		if(feature == data.attrCnt)
			return data.labelNameMap.get(label);
		else
			return nominalAttrMap.get(feature);
	}
}
